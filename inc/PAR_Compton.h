...
private:
    ...
    GH1*	Com_MM_hm;
    //GH1*	Com_pMass;
    GH1*	Com_MM_OA_hp_124_149;
    GH1*	Com_MM_OA_hm_124_149;

    GH1*	Com_MM_OA_hp_105_124;
    GH1*	Com_MM_OA_hm_105_124;

    GH1*	Com_MM_OA_hp_88_105;
    GH1*	Com_MM_OA_hm_88_105;

    GH1*	Com_MM_OA_hp_70_88;
    GH1*	Com_MM_OA_hm_70_88;
    ...
    GH1*	CBRing_MM_OA_hp_124_149;
    GH1*	CBRing_MM_OA_hm_124_149;

    GH1*	CBRing_MM_OA_hp_105_124;
    GH1*	CBRing_MM_OA_hm_105_124;

    GH1*	CBRing_MM_OA_hp_88_105;
    GH1*	CBRing_MM_OA_hm_88_105;

    GH1*	CBRing_MM_OA_hp_70_88;
    GH1*	CBRing_MM_OA_hm_70_88;
