...
private:
   ...
   // GH1*	Com_pMass;
    ...
    GH1*	Ring_MM_OA_hp_10;
    GH1*	Ring_MM_OA_hm_10;

    GH1*	Ring_MM_OA_hp_20;
    GH1*	Ring_MM_OA_hm_20;

    GH1*	Ring_MM_OA_hp_30;
    GH1*	Ring_MM_OA_hm_30;

    GH1*	Ring_MM_OA_hp_40;
    GH1*	Ring_MM_OA_hm_40;

    GH1*	Ring_MM_OA_hp_50;
    GH1*	Ring_MM_OA_hm_50;

    GH1*	Ring_MM_OA_hp_60;
    GH1*	Ring_MM_OA_hm_60;

    GH1*	Ring_MM_OA_hp_70;
    GH1*	Ring_MM_OA_hm_70;

    GH1*	Ring_MM_OA_hp_80;
    GH1*	Ring_MM_OA_hm_80;

    GH1*	Ring_MM_OA_hp_90;
    GH1*	Ring_MM_OA_hm_90;

    GH1*	Ring_MM_OA_hp_100;
    GH1*	Ring_MM_OA_hm_100;

    GH1*	Ring_MM_OA_hp_110;
    GH1*	Ring_MM_OA_hm_110;

    GH1*	Ring_MM_OA_hp_120;
    GH1*	Ring_MM_OA_hm_120;

    GH1*	Ring_MM_OA_hp_130;
    GH1*	Ring_MM_OA_hm_130;

    GH1*	Ring_MM_OA_hp_140;
    GH1*	Ring_MM_OA_hm_140;

    GH1*	Ring_MM_OA_hp_150;
    GH1*	Ring_MM_OA_hm_150;
