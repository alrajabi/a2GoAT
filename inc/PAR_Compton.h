...
private:
    ...
    GH1*	Com_MM_hm;
    //GH1*	Com_pMass;
    GH1*	Com_MM_OA_hp_140_155;
    GH1*	Com_MM_OA_hm_140_155;

    GH1*	Com_MM_OA_hp_125_140;
    GH1*	Com_MM_OA_hm_125_140;

    GH1*	Com_MM_OA_hp_110_125;
    GH1*	Com_MM_OA_hm_110_125;

    GH1*	Com_MM_OA_hp_95_110;
    GH1*	Com_MM_OA_hm_95_110;

    GH1*	Com_MM_OA_hp_70_95;
    GH1*	Com_MM_OA_hm_70_95;
    ...
    GH1*	CBRing_MM_OA_hm_140_149;
	
    GH1*	CBRing_MM_OA_hp_125_140;
    GH1*	CBRing_MM_OA_hm_125_140;

    GH1*	CBRing_MM_OA_hp_110_125;
    GH1*	CBRing_MM_OA_hm_110_125;

    GH1*	CBRing_MM_OA_hp_95_110;
    GH1*	CBRing_MM_OA_hm_95_110;

    GH1*	CBRing_MM_OA_hp_70_95;
    GH1*	CBRing_MM_OA_hm_70_95;
    ...
    GH1*	CBFRing_IM;
    GH1*	Time_CBFRing;
    GH1*	CBFRing_MM_OA_hp_140_155;
    GH1*	CBFRing_MM_OA_hm_140_155;
	
    GH1*	CBFRing_MM_OA_hp_125_140;
    GH1*	CBFRing_MM_OA_hm_125_140;

    GH1*	CBFRing_MM_OA_hp_110_125;
    GH1*	CBFRing_MM_OA_hm_110_125;

    GH1*	CBFRing_MM_OA_hp_95_110;
    GH1*	CBFRing_MM_OA_hm_95_110;

    GH1*	CBFRing_MM_OA_hp_70_95;
    GH1*	CBFRing_MM_OA_hm_70_95;
